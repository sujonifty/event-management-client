        ...
        >
            ...
            <div className="flex  flex-col md:flex-row gap-4 sm:h-64 xl:h-80 2xl:h-96">
                <div className="container flex flex-col items-center mx-auto mb-12 md:p-10 md:px-12">
                    <h1 className="p-4 text-4xl md:text-5xl font-bold text-white leading-none text-center">What our customers are saying about us</h1>
                </div>
                <Carousel indicators={false}>
                    <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly p-2">
                        <Card className=" flex flex-col max-w-sm  bg-cyan-50 shadow-lg">
                            ...
                            <div className="flex flex-col items-center justify-center p-4 rounded-b-lg  text-white">
                                <Image
                    ...
                    <div className="container rounded-lg flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly p-2">
                        <Card className=" flex flex-col max-w-sm  bg-cyan-50 shadow-lg">
                            <div className="px-2 py-6 rounded-t-lg">
                                <p className="relative px-6 py-1 text-lg italic text-center ">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-8 h-8 text-violet-400">
