    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 text-center">
          <div className="flex my-4 lg:my-16 flex-col md:flex-row gap-4 sm:h-64 xl:h-80 2xl:h-96">
            <div className="container flex flex-col items-center mx-auto mb-12 md:p-10 md:px-12">
              <h1 className="p-4 text-4xl md:text-5xl font-bold text-gray-100 leading-none text-center">
            ...
            >
              <div className="container flex flex-col items-center justify-center mx-auto p-2">
                <h1 className="text-white">Customer 1: "Great service!"</h1>
              </div>
              <div className="container flex flex-col items-center justify-center mx-auto p-2">
                <h1 className="text-white">Customer 2: "Excellent product quality!"</h1>
              </div>
              <div className="container flex flex-col items-center justify-center mx-auto p-2">
                <h1 className="text-white">Customer 3: "Highly recommend!"</h1>
              </div>
            </Carousel>
          </div>
        </div>
